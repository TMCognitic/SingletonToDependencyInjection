...
namespace DemoAppWebCore
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IConnectionInfo, ConnectionInfo>((sp) => new ConnectionInfo(@"Data Source=AW-BRIAREOS\SQL2016DEV;Initial Catalog=GestContact;Integrated Security=True;"));
